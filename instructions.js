var instructions = {
  ...
  end_fullscreen : "<h2>This was it!</h2> <p>Please save your data by clicking 'Save & Exit'. You'll get your\
                   confirmation code on the next page.</p>",

  confirmation : '<h2>This session is over</h2><p>Please go back to the survey form and paste the following code into the\
                input form: <span id="conf_code">###</span></p><p>After copying the confirmation code, you can close this browser window or tab.</p>'
};
